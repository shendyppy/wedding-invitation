...
export function CountdownSection() {
  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative z-10 flex flex-col items-center justify-between w-full flex-1 px-4 py-16">
        <div />

        <p className={`anim-fade-up ${vis} font-serif italic text-[var(--color-warm-gray)] text-lg`}>
          Are getting married!
        </p>

        <div
          className={`${vis ? "line-grow" : ""} w-px bg-[var(--color-warm-gray)]/40`}
          style={{ "--line-height": "40vh", height: isVisible ? "40vh" : "0", opacity: isVisible ? 1 : 0 } as React.CSSProperties}
        />

        <p className={`anim-fade-up ${vis} anim-delay-200 font-serif italic text-[var(--color-warm-gray)] text-lg`}>
          Counting down...
        </p>
